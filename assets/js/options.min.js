        ...
        return function(b) {
            ...
            return a.m = b, a.c = c, a.d = function(b, c, d) {
                ...
                if (a.r(d), Object.defineProperty(d, "default", {
                    ...
                    for (var e in b) a.d(d, e, (function(a) {
                        return b[a]
                    }).bind(null, e));
                return d
            }, a.n = function(c) {
            ...
            var c = function(b) {
                function a(c, d) {
                    ...
                    return b.resolveOptions(d), b.listenClick(c), b
                }
                return function(b, a) {
                    ...
                    value: function() {
                        ...
                        this.action = "function" == typeof a.action ? a.action : this.defaultAction, this.target = "function" == typeof a.target ? a.target : this.defaultTarget, this.text = "function" == typeof a.text ? a.text : this.defaultText, this.container = "object" === e(a.container) ? a.container : document.body
                    }
                }, {
                    key: "listenClick",
                    value: function(a) {
                        var b = this;
                        this.listener = (0, i.default)(a, "click", function(a) {
                            return b.onClick(a)
                        })
                    }
                }, {
            ...
            "use strict";
            var a, f = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(a) {
                    return typeof a
                } : function(a) {
                    return a && "function" == typeof Symbol && a.constructor === Symbol && a !== Symbol.prototype ? "symbol" : typeof a
                },
                ...
                d = function() {
                    ...
                    return g(a, [{
                        ...
                        value: function() {
                            ...
                            this.fakeElem.style.top = b + "px", this.fakeElem.setAttribute("readonly", ""), this.fakeElem.value = this.text, this.container.appendChild(this.fakeElem), this.selectedText = (0, h.default)(this.fakeElem), this.copyText()
                        }
                    }, {
                        key: "removeFake",
                        value: function() {
                        ...
                        key: "selectTarget",
                        value: function() {
                            this.selectedText = (0, h.default)(this.target), this.copyText()
                        }
                    }, {
                        key: "copyText",
                        value: function() {
            ...
            a.exports = function(a) {
                ...
                if ("SELECT" === a.nodeName) a.focus(), b = a.value;
                    ...
                    d || a.setAttribute("readonly", ""), a.select(), a.setSelectionRange(0, a.value.length), d || a.removeAttribute("readonly"), b = a.value
                } else {
                    a.hasAttribute("contenteditable") && a.focus();
                    var c = window.getSelection(),
                        e = document.createRange();
                    e.selectNodeContents(a), c.removeAllRanges(), c.addRange(e), b = c.toString()
                }
                return b
            }
        }, function(b, c) {
            ...
            b.exports = function(a, b, c) {
                ...
                if (d.node(a)) return j = b, k = c, (n = a).addEventListener(j, k), {
                    destroy: function() {
                        n.removeEventListener(j, k)
                    }
                };
                if (d.nodeList(a)) return i = a, l = b, m = c, Array.prototype.forEach.call(i, function(a) {
                    a.addEventListener(l, m)
                }), {
                    destroy: function() {
                        Array.prototype.forEach.call(i, function(a) {
                            a.removeEventListener(l, m)
                        })
                    }
                };
                if (d.string(a)) return f = a, g = b, h = c, e(document.body, f, g, h);
            ...
            function e(a, f, b, g, c) {
                var e = (function(a, b, c, e) {
                    return function(c) {
                        c.delegateTarget = d(c.target, b), c.delegateTarget && e.call(a, c)
                    }
            ...
            a.exports = function(a, c, b, d, f) {
                return "function" == typeof a.addEventListener ? e.apply(null, arguments) : "function" == typeof b ? e.bind(null, document).apply(null, arguments) : ("string" == typeof a && (a = document.querySelectorAll(a)), Array.prototype.map.call(a, function(a) {
                    return e(a, c, b, d, f)
                }))
            }
        }, function(b, c) {
...
function test_speed(a) {
    var e = get_time(),
        ...
        f = a.post_url,
        b = a.id,
        d = ".test_speed_status_" + b,
        g = ".test_speed_time_" + b;
    $(d).html('<img width="15px" src="assets/img/loading.gif" />'), (query = {
        url: c,
        method: "GET"
    }).success = function(c) {
        var b = get_time() - e;
        b = b.toFixed(3), $(g).html(b), a.ping_time = b, post(f, a, null, null, 1), $(d).html(c), $(g).html(b)
    }, query.error = function(a) {
        $(d).html("ERR")
    }, $.ajax(query)
}

function handle_options(a) {
    a.hasOwnProperty("set_token") && set_token(a.set_token), a.hasOwnProperty("session") && chrome.runtime.sendMessage({
        action: "update",
        session: a.session
    }), a.hasOwnProperty("location") && (window.location = a.location), a.hasOwnProperty("open_url") && window.open(a.open_url, "ghelper"), a.hasOwnProperty("html") && handle_body(a.html), a.hasOwnProperty("tester") && test_server(a.tester)
}

function handle_body(a) {
    $("body").html(a), $("form").submit(function() {
        var a = $(this).attr("action"),
            b = $(this).serialize();
        return post(a, b, handle_options), $("button").attr("disabled", "true"), !1
    }), $(".ajax").click(function() {
        return get($(this).attr("href"), handle_options), !1
    }), handler_copy(".copy")
}

function get_request_url(c = "/options") {
    var a = window.location.href,
        b = a.indexOf("?");
    return !(b < 0) && (url = a.slice(b + 1)) ? url : c
}
...
function get_query(a) {
    ...
    for (val in c) b[(q = c[val].split("="))[0]] = q[1];
    return b
}

function load_page(a = "/options") {
    var a = get_request_url(a);
    get(a, handle_options)
}

function handler_copy(a) {
    new ClipboardJS(a).on("success", function(a) {
        alert(getlang("copy_successful"))
    })
}
api_urls.push("https://api.phantomshuttle.space/api/v1"), api_urls.push("https://api.redsuns.live/api/api/v1"), api_urls.push("https://api.theknewone.com/api/v1"), load_page()