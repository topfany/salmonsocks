 ...
 */
if ( /*! jQuery v3.4.1 | (c) JS Foundation and other contributors | jquery.org/license */ ! function(a, b) {
    "use strict";
...
(function(b) {
    ...
    function(b) {
        ...
        a.VERSION = "3.3.7", a.TRANSITION_DURATION = 150, a.DEFAULTS = {
            ...
            var a = c instanceof this.constructor ? c : b(c.currentTarget).data("bs." + this.type);
            if (a || (a = new this.constructor(c.currentTarget, this.getDelegateOptions()), b(c.currentTarget).data("bs." + this.type, a)), c instanceof b.Event && (a.inState["focusout" == c.type ? "focus" : "hover"] = !1), !a.isInStateTrue()) return clearTimeout(a.timeout), a.hoverState = "out", a.options.delay && a.options.delay.hide ? void(a.timeout = setTimeout(function() {
            ...
            if (this.$element.trigger(e), !e.isDefaultPrevented()) return c.removeClass("in"), b.support.transition && c.hasClass("fade") ? c.one("bsTransitionEnd", d).emulateTransitionEnd(a.TRANSITION_DURATION) : d(), this.hoverState = null, this
    ...
    function(b) {
        ...
        a.VERSION = "3.3.7", a.RESET = "affix affix-top affix-bottom", a.DEFAULTS = {
            ...
            if (null != a && "top" == this.affixed) return b < a && "top";
            if ("bottom" == this.affixed) return null != a ? !(b + this.unpin <= e.top) && "bottom" : !(b + f <= d - c) && "bottom";
            var g = null == this.affixed,
                i = g ? b : e.top,
                j = g ? f : h;
            return null != a && b <= a ? "top" : null != c && i + j >= d - c && "bottom"
    ...
    function(b, a) {
        "function" == typeof define && define.amd ? define(["jquery"], a) : "undefined" != typeof exports ? a(require("jquery")) : (a(b.jquery), b.bootstrapSwitch = {})
    }(this, function(c) {
        "use strict";
        var a, d = (a = c) && a.__esModule ? a : {
                default: a
            },
            f = Object.assign || function(d) {
            ...
            g = function() {
                function a(d, c) {
                    for (var a, b = 0; b < c.length; b++)(a = c[b]).enumerable = a.enumerable || !1, a.configurable = !0, "value" in a && (a.writable = !0), Object.defineProperty(d, a.key, a)
                }
                return function(b, c, d) {
                    return c && a(b.prototype, c), d && a(b, d), b
                }
            }(),
            b = d.default || window.jQuery || window.$,
            e = function() {
                function a(c) {
                    var e = this,
                    ...
                    })(this, a), this.$element = b(c), this.options = b.extend({}, b.fn.bootstrapSwitch.defaults, this._getElementOptions(), d), this.prevOptions = {}, this.$wrapper = b("<div>", {
                        class: function() {
                            var a = [];
                            return a.push(e.options.state ? "on" : "off"), e.options.size && a.push(e.options.size), e.options.disabled && a.push("disabled"), e.options.readonly && a.push("readonly"), e.options.indeterminate && a.push("indeterminate"), e.options.inverse && a.push("inverse"), e.$element.attr("id") && a.push("id-" + e.$element.attr("id")), a.map(e._getClass.bind(e)).concat([e.options.baseClass], e._getClasses(e.options.wrapperClass)).join(" ")
                        }
                    ...
                    }), this.$element.on("init.bootstrapSwitch", this.options.onInit.bind(this, c)), this.$element.on("switchChange.bootstrapSwitch", function() {
                        for (var d = arguments.length, f = Array(d), a = 0; a < d; a++) f[a] = arguments[a];
                        !1 === e.options.onSwitchChange.apply(c, f) && (e.$element.is(":radio") ? b('[name="' + e.$element.attr("name") + '"]').trigger("previousState.bootstrapSwitch", !0) : e.$element.trigger("previousState.bootstrapSwitch", !0))
                ...
                return g(a, [{
                    key: "setPrevOptions",
                    value: function() {
                        this.prevOptions = f({}, this.options)
                    }
                }, {
                    key: "state",
                    value: function(a, c) {
                        return void 0 === a ? this.options.state : (this.options.disabled || this.options.readonly || this.options.state && !this.options.radioAllOff && this.$element.is(":radio") || (this.$element.is(":radio") ? b('[name="' + this.$element.attr("name") + '"]').trigger("setPreviousOptions.bootstrapSwitch") : this.$element.trigger("setPreviousOptions.bootstrapSwitch"), this.options.indeterminate && this.indeterminate(!1), this.$element.prop("checked", !!a).trigger("change.bootstrapSwitch", c)), this.$element)
                    }
                }, {
                    key: "toggleState",
                    value: function(a) {
                    ...
                    key: "size",
                    value: function(a) {
                        return void 0 === a ? this.options.size : (null != this.options.size && this.$wrapper.removeClass(this._getClass(this.options.size)), a && this.$wrapper.addClass(this._getClass(a)), this._width(), this._containerPosition(), this.options.size = a, this.$element)
                    }
                }, {
                    key: "animate",
                    value: function(a) {
                        return void 0 === a ? this.options.animate : !!a === this.options.animate ? this.$element : this.toggleAnimate()
                    }
                }, {
                    key: "toggleAnimate",
                    value: function() {
                    ...
                    key: "disabled",
                    value: function(a) {
                        return void 0 === a ? this.options.disabled : !!a === this.options.disabled ? this.$element : this.toggleDisabled()
                    }
                }, {
                    key: "toggleDisabled",
                    value: function() {
                    ...
                    key: "readonly",
                    value: function(a) {
                        return void 0 === a ? this.options.readonly : !!a === this.options.readonly ? this.$element : this.toggleReadonly()
                    }
                }, {
                    key: "toggleReadonly",
                    value: function() {
                    ...
                    key: "indeterminate",
                    value: function(a) {
                        return void 0 === a ? this.options.indeterminate : !!a === this.options.indeterminate ? this.$element : this.toggleIndeterminate()
                    }
                }, {
                    ...
                    key: "inverse",
                    value: function(a) {
                        return void 0 === a ? this.options.inverse : !!a === this.options.inverse ? this.$element : this.toggleInverse()
                    }
                }, {
                    key: "toggleInverse",
                    value: function() {
                        this.$wrapper.toggleClass(this._getClass("inverse"));
                        var a = this.$on.clone(!0),
                            b = this.$off.clone(!0);
                    ...
                    key: "onColor",
                    value: function(a) {
                        return void 0 === a ? this.options.onColor : (this.options.onColor && this.$on.removeClass(this._getClass(this.options.onColor)), this.$on.addClass(this._getClass(a)), this.options.onColor = a, this.$element)
                    }
                }, {
                    key: "offColor",
                    value: function(a) {
                        return void 0 === a ? this.options.offColor : (this.options.offColor && this.$off.removeClass(this._getClass(this.options.offColor)), this.$off.addClass(this._getClass(a)), this.options.offColor = a, this.$element)
                    }
                }, {
                    key: "onText",
                    value: function(a) {
                        return void 0 === a ? this.options.onText : (this.$on.html(a), this._width(), this._containerPosition(), this.options.onText = a, this.$element)
                    }
                }, {
                    key: "offText",
                    value: function(a) {
                        return void 0 === a ? this.options.offText : (this.$off.html(a), this._width(), this._containerPosition(), this.options.offText = a, this.$element)
                    }
                }, {
                    key: "labelText",
                    value: function(a) {
                        return void 0 === a ? this.options.labelText : (this.$label.html(a), this._width(), this.options.labelText = a, this.$element)
                    }
                }, {
                    key: "handleWidth",
                    value: function(a) {
                        return void 0 === a ? this.options.handleWidth : (this.options.handleWidth = a, this._width(), this._containerPosition(), this.$element)
                    }
                }, {
                    key: "labelWidth",
                    value: function(a) {
                        return void 0 === a ? this.options.labelWidth : (this.options.labelWidth = a, this._width(), this._containerPosition(), this.$element)
                    }
                }, {
                    key: "baseClass",
                    value: function() {
                    ...
                    key: "wrapperClass",
                    value: function(a) {
                        return void 0 === a ? this.options.wrapperClass : (a || (a = b.fn.bootstrapSwitch.defaults.wrapperClass), this.$wrapper.removeClass(this._getClasses(this.options.wrapperClass).join(" ")), this.$wrapper.addClass(this._getClasses(a).join(" ")), this.options.wrapperClass = a, this.$element)
                    }
                }, {
                    key: "radioAllOff",
                    value: function(a) {
                        if (void 0 === a) return this.options.radioAllOff;
                        var b = !!a;
                        return this.options.radioAllOff === b || (this.options.radioAllOff = b), this.$element
                    }
                }, {
                    key: "onInit",
                    value: function(a) {
                        return void 0 === a ? this.options.onInit : (a || (a = b.fn.bootstrapSwitch.defaults.onInit), this.options.onInit = a, this.$element)
                    }
                }, {
                    key: "onSwitchChange",
                    value: function(a) {
                        return void 0 === a ? this.options.onSwitchChange : (a || (a = b.fn.bootstrapSwitch.defaults.onSwitchChange), this.options.onSwitchChange = a, this.$element)
                    }
                }, {
                    key: "destroy",
                    value: function() {
                    ...
                    value: function() {
                        var c = this,
                            a = this.$on.add(this.$off).add(this.$label).css("width", ""),
                            b = "auto" === this.options.handleWidth ? Math.round(Math.max(this.$on.width(), this.$off.width())) : this.options.handleWidth;
                        return a.width(b), this.$label.width(function(d, a) {
                            return "auto" === c.options.labelWidth ? a < b ? b : a : c.options.labelWidth
                    ...
                    value: function() {
                        var a = this,
                            b = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : this.options.state;
                        arguments[1], this.$container.css("margin-left", function() {
                    ...
                    value: function() {
                        var b = this,
                            a = function() {
                                b.setPrevOptions(), b._width(), b._containerPosition(), setTimeout(function() {
                                    if (b.options.animate) return b.$wrapper.addClass(b._getClass("animate"))
                                }, 50)
                            };
                        if (this.$wrapper.is(":visible")) return void a();
                        var c = window.setInterval(function() {
                            if (b.$wrapper.is(":visible")) return a(), window.clearInterval(c)
                        }, 50)
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        return this.$element.on({
                            ...
                            "previousState.bootstrapSwitch": function() {
                                a.options = a.prevOptions, a.options.indeterminate && a.$wrapper.addClass(a._getClass("indeterminate")), a.$element.prop("checked", a.options.state).trigger("change.bootstrapSwitch", !0)
                            },
                            "change.bootstrapSwitch": function(d, e) {
                                d.preventDefault(), d.stopImmediatePropagation();
                                var c = a.$element.is(":checked");
                                a._containerPosition(c), c !== a.options.state && (a.options.state = c, a.$wrapper.toggleClass(a._getClass("off")).toggleClass(a._getClass("on")), e || (a.$element.is(":radio") && b('[name="' + a.$element.attr("name") + '"]').not(a.$element).prop("checked", !1).trigger("change.bootstrapSwitch", !0), a.$element.trigger("switchChange.bootstrapSwitch", [c])))
                            },
                            "focus.bootstrapSwitch": function(b) {
                                b.preventDefault(), a.$wrapper.addClass(a._getClass("focused"))
                            },
                            "blur.bootstrapSwitch": function(b) {
                                b.preventDefault(), a.$wrapper.removeClass(a._getClass("focused"))
                            },
                            "keydown.bootstrapSwitch": function(b) {
                                !b.which || a.options.disabled || a.options.readonly || (37 === b.which || 39 === b.which) && (b.preventDefault(), b.stopImmediatePropagation(), a.state(39 === b.which))
                            }
                        })
                    }
                }, {
                        ...
                        this.$label.on({
                            ...
                            "mousemove.bootstrapSwitch touchmove.bootstrapSwitch": function(b) {
                                if (null != a._dragStart) {
                                    ...
                                    b.preventDefault(), c < -a._handleWidth || 0 < c || (a._dragEnd = c, a.$container.css("margin-left", a._dragEnd + "px"))
                                }
                            },
                            "mouseup.bootstrapSwitch touchend.bootstrapSwitch": function(c) {
                                if (a._dragStart) {
                                    if (c.preventDefault(), a.options.animate && a.$wrapper.addClass(a._getClass("animate")), a._dragEnd) {
                                        var b = a._dragEnd > -(a._handleWidth / 2);
                                        a._dragEnd = !1, a.state(a.options.inverse ? !b : b)
                    ...
                    value: function() {
                        var b = this,
                            a = this.$element.closest("label");
                        a.on("click", function(c) {
                            c.preventDefault(), c.stopImmediatePropagation(), c.target === a[0] && b.toggleState()
                        })
                    }
                }, {
                    key: "_formHandler",
                    value: function() {
                        var a = this.$element.closest("form");
                        a.data("bootstrap-switch") || a.on("reset.bootstrapSwitch", function() {
                            window.setTimeout(function() {
                                a.find("input").filter(function() {
                    ...
                    key: "_getClasses",
                    value: function(a) {
                        return b.isArray(a) ? a.map(this._getClass.bind(this)) : [this._getClass(a)]
                    }
                }]), a
            }();
        b.fn.bootstrapSwitch = function(f) {
            for (var c = arguments.length, d = Array(1 < c ? c - 1 : 0), a = 1; a < c; a++) d[a - 1] = arguments[a];
            return Array.prototype.reduce.call(this, function(i, c) {
                var g = b(c),
                    h = g.data("bootstrap-switch"),
                    a = h || new e(c, f);
                return h || g.data("bootstrap-switch", a), "string" == typeof f ? a[f].apply(a, d) : i
            }, this)
        }, b.fn.bootstrapSwitch.Constructor = e, b.fn.bootstrapSwitch.defaults = {
            state: !0,
            size: null,
            animate: !0,
            disabled: !1,
...
function get_current_webdomain() {
    return localStorage.getItem("currentWebDomain")
}
...
function load_page() {
    send_message("reload", function(a) {
        get("/popup", show_popup, show_error)
    })
}

function show_popup(a) {
    if (a.hasOwnProperty("html") && ($("body").html(a.html), handle_form()), a.hasOwnProperty("current_webdomain_proxy_status") && a.current_webdomain_proxy_status.hasOwnProperty("domain_name")) {
        get_current_tab_url();
        var b = localStorage.currentTabUrl;
        "chrome://" != b.substring(0, 9) && "chrome-extension://" != b.substring(0, 19) && localStorage.currentWebDomain == a.current_webdomain_proxy_status.domain_name && $("#current_domain").html(localStorage.currentWebDomain)
    }
    a.hasOwnProperty("session") && chrome.runtime.sendMessage({
        action: "update",
        session: a.session
    }, function(a) {
        get("/check", function(a) {
            $("#checking").html(a)
        })
    }), a.hasOwnProperty("open_url") && window.open(a.open_url, "ghelper"), a.hasOwnProperty("location") && (window.location = a.location)
}

function handle_form() {
    $(".switchsmall").bootstrapSwitch(), $(".switchsmall").on("switchChange.bootstrapSwitch", post_popup), $("select").on("change", post_popup)
}
...
function post_popup() {
    ...
    var a = $("form").attr("action"),
        b = $("form").serialize();
    post(a, b, show_popup, show_error)
}
...
function get_current_tab_url() {
    chrome.tabs.query({ active: true, currentWindow: true }, function(tabs) {
        ...
        localStorage.currentTabUrl = currentTabUrl, set_web_domain()
    });
}

function set_web_domain() {
    if (localStorage.currentTabUrl) {
        var a = localStorage.currentTabUrl;
        "chrome://" != a.substring(0, 9) && "chrome-extension://" != a.substring(0, 19) && (a = getDomain(localStorage.currentTabUrl, !1)) ? localStorage.currentWebDomain = a : localStorage.currentWebDomain = ""
    }
}
...
api_urls.push("https://api.phantomshuttle.space/api/v1"), api_urls.push("https://api.phantomshuttle.space/api/v1"), api_urls.push("https://api.redsuns.live/api/api/v1"), api_urls.push("https://api.theknewone.com/api/v1"), get_current_tab_url(), load_page()